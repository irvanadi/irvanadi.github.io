	...
	return (
		...
		>
			...
			<div className="relative max-w-4xl mx-auto text-center">
				{/* Photo Frame */}
				<AnimatedElement animation="scaleIn" delay={0.1}>
					<div className="mb-8">
						<div className="relative w-32 h-32 mx-auto">
							{/* Animated border ring */}
							<div className="absolute inset-0 rounded-full bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 animate-spin-slow p-1">
								<div className="w-full h-full rounded-full bg-gray-900"></div>
							</div>
							{/* Photo container */}
							<div className="absolute inset-2 rounded-full overflow-hidden bg-gradient-to-br from-gray-700 to-gray-800 flex items-center justify-center">
								{/* Replace this div with an img tag and your actual photo */}
								{/* Example: <img src="/profile-photo.jpg" alt="Profile" className="w-full h-full object-cover" /> */}
								{/* <div className="text-4xl text-gray-400">👨‍💻</div> */}
								{/* Uncomment and replace with your photo: */}
								<Image
									src={photo}
									alt="Your Name"
				...
				<AnimatedElement animation="fadeInUp" delay={1.0}>
					<div className="mt-12 flex justify-center items-center gap-8">
						...
						<a
							...
							className="group flex items-center gap-3 bg-white/5 hover:bg-blue-600/20 backdrop-blur-sm border border-white/10 hover:border-blue-400/30 rounded-lg px-4 py-3 transition-all duration-300"
						>
							<div className="w-6 h-6 text-blue-400 group-hover:text-blue-300">
								<svg
									viewBox="0 0 24 24"
									fill="currentColor"
						...
						<a
							...
							target="_blank"
							rel="noopener noreferrer"
							className="group flex items-center gap-3 bg-white/5 hover:bg-gray-700/30 backdrop-blur-sm border border-white/10 hover:border-gray-400/30 rounded-lg px-4 py-3 transition-all duration-300"
						>
							<div className="w-6 h-6 text-gray-400 group-hover:text-white">
								<svg
									viewBox="0 0 24 24"
									fill="currentColor"
									className="w-full h-full"
						...
						<a
							...
							className="group flex items-center gap-3 bg-white/5 hover:bg-emerald-600/20 backdrop-blur-sm border border-white/10 hover:border-emerald-400/30 rounded-lg px-4 py-3 transition-all duration-300"
						>
							<div className="w-6 h-6 text-emerald-400 group-hover:text-emerald-300">
								<svg
									viewBox="0 0 24 24"
									fill="currentColor"
									className="w-full h-full"
